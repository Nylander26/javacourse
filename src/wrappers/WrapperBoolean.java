...
public class WrapperBoolean {
    public static void main(String[] args) {
        ...
        Boolean objBoolean = Boolean.valueOf(primBoolean); // -> Pasar de primitivo a referencia --- Boxing
        Boolean objBoolean2 = Boolean.valueOf("false");
        Boolean objBoolean3 = true;

        System.out.println("primBoolean = " + primBoolean);
        System.out.println("objBoolean1 = " + objBoolean);
        ...
        boolean primBoolean2 = objBoolean2.booleanValue(); // -> Pasar de referencia a primitivo --- Unboxing
    }
}
